...
public class TextManager extends Mod {
    ...
    public String getPrefix() {
        return "\u00a7r" + ChatFormatting.WHITE + "[" + "§r" + "§l" + "Dec"  + "§(" + "] " + ChatFormatting.RESET;
    }
