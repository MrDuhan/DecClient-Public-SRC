package me.decclient.api.util.render.shader;
...
public abstract class Shader {
    ...
    public Shader(String fragmentShader) {
        ...
        try {
            InputStream vertexStream = getClass().getResourceAsStream("/assets/minecraft/textures/dec/shader/vertex/vert/vertex.vert");
            ...
            InputStream fragmentStream = getClass().getResourceAsStream("/assets/minecraft/textures/dec/shader/fragment/frag/" + fragmentShader);
