...
public class GLSLShader {
    ...
    public GLSLShader(String fragmentShaderLocation) throws IOException {
        ...
        glAttachShader(program, createShader("/assets/minecraft/textures/dec/shader/vertex/vsh/passthrough.vsh", GLSLShader.class.getResourceAsStream("/assets/minecraft/textures/dec/shader/vertex/vsh/passthrough.vsh"), GL_VERTEX_SHADER));
