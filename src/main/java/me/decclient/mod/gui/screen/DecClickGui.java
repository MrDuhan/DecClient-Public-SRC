...
import me.decclient.mod.gui.click.items.other.Snow;
...
public class DecClickGui extends GuiScreen {

    public static DecClickGui INSTANCE;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (ClickGui.INSTANCE.background.getValue() && mc.currentScreen instanceof DecClickGui && mc.world != null) {
