package me.decclient.mod.gui.click.items.buttons;
...
public class PickerButton extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawRect(x, y, x + (float) width + 7.4f, y + (float) height - 0.5f,
                (future || dotgod) ? ((setting.hasBoolean && setting.booleanValue) ? (!isHovering(mouseX, mouseY) ? Managers.COLORS.getCurrentWithAlpha(65) : Managers.COLORS.getCurrentWithAlpha(90)) :
                        (!isHovering(mouseX, mouseY) ? Managers.COLORS.getCurrentWithAlpha(26) : Managers.COLORS.getCurrentWithAlpha(55))) :
                        setting.hasBoolean ? setting.booleanValue ? (!isHovering(mouseX, mouseY) ? Managers.COLORS.getCurrentWithAlpha(120) : Managers.COLORS.getCurrentWithAlpha(200)) : (!isHovering(mouseX, mouseY) ? 0x11555555 : -2007673515) :
                        !isHovering(mouseX, mouseY) ? 0x11555555 : -2007673515);
        ...
        Managers.TEXT.drawStringWithShadow(((newStyle || dotgod) ? getName().toLowerCase() : getName()), x + 2.3f, y - 1.7f - (float) DecClickGui.INSTANCE.getTextOffset(), (dotgod && setting.hasBoolean && setting.booleanValue) ? Managers.COLORS.getCurrentGui(240) : dotgod ? 0xB0B0B0 : -1);
    ...
    public boolean isInsideCopy(int mouseX, int mouseY) {
        return mouseOver((int) ((int) x + 2.3f), (int) y + 113, (int) ((int) x + 2.3f) + Managers.TEXT.getStringWidth("copy"), (int)(y + 112.0f) + Managers.TEXT.getFontHeight(), mouseX, mouseY);
    }

    public boolean isInsidePaste(int mouseX, int mouseY) {
        return mouseOver((int) (x + (float) width - 2.3f - Managers.TEXT.getStringWidth("paste") + 11.7f - 4.6f), (int) y + 113, (int) (x + (float) width - 2.3f - Managers.TEXT.getStringWidth("paste") + 11.7f - 4.6f) + Managers.TEXT.getStringWidth("paste"), (int)(y + 112.0f) + Managers.TEXT.getFontHeight(), mouseX, mouseY);
    }
    ...
    public void drawPicker(Setting setting, int pickerX, int pickerY, int hueSliderX, int hueSliderY, int alphaSliderX, int alphaSliderY, int mouseX, int mouseY) {
        ...
        try {
            ...
            Dec.LOGGER.info("dec color picker says it's a bad color!");
        }
    ...
    public float getHueX() {
        ...
        hueX = prevHueX + (hueX - prevHueX) * mc.getRenderPartialTicks() / (8 * (Math.min(240, Managers.FPS.getFPS()) / 240f));
        return hueX;
    }
    ...
    public float getAlphaX() {
        ...
        alphaX = prevAlphaX + (alphaX - prevAlphaX) * mc.getRenderPartialTicks() / (8 * (Math.min(240, Managers.FPS.getFPS()) / 240f));
        return alphaX;
    }
