...
public class UnlimitedSlider
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Managers.TEXT.drawStringWithShadow(" - " + (newStyle ? setting.getName().toLowerCase() + ":" : setting.getName()) + " " + ChatFormatting.GRAY + setting.getValue() + ChatFormatting.WHITE + " +", x + 2.3f, y - 1.7f - (float) DecClickGui.INSTANCE.getTextOffset(), getState() ? -1 : -5592406);
    }
