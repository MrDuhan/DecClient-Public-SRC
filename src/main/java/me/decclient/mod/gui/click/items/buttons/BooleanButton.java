...
import static me.decclient.mod.gui.click.Component.calculateRotation;
...
public class BooleanButton extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (future) {
            ...
            Managers.TEXT.drawStringWithShadow((newStyle ? getName().toLowerCase() : getName()), x + 2.3f, y - 1.7f - (float) DecClickGui.INSTANCE.getTextOffset(), getState() ? -1 : -5592406);
            ...
            Managers.TEXT.drawStringWithShadow((getName().toLowerCase()), x + 2.3f, y - 1.7f - (float) DecClickGui.INSTANCE.getTextOffset(), getState() ? Managers.COLORS.getCurrentGui(240) : 0xB0B0B0);
        ...
        if (setting.parent) {
            ...
            if (future) {
                ...
                mc.getTextureManager().bindTexture(new ResourceLocation("textures/dec/gear.png"));
                ...
                Managers.TEXT.drawStringWithShadow(color + gear,
                        ...
                        y - 2.2f - (float) DecClickGui.INSTANCE.getTextOffset(), -1);
            }
        }
    }
