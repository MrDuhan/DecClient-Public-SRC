package me.decclient.mod.gui.click;
...
import me.decclient.mod.gui.click.items.buttons.Button;
...
public class Component extends Mod {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Managers.TEXT.drawStringWithShadow(getName(), (float) x + 3.0f, (float) y - 4.0f - (float) DecClickGui.INSTANCE.getTextOffset(), -1);
    ...
    public void drawArrow() {
        ...
        mc.getTextureManager().bindTexture(new ResourceLocation("textures/dec/arrow.png"));
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0 && isHovering(mouseX, mouseY)) {
            x2 = x - mouseX;
            y2 = y - mouseY;
            DecClickGui.INSTANCE.getComponents().forEach(component -> {
                if (component.drag) {
