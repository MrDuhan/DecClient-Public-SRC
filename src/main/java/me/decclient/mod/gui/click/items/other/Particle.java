package me.decclient.mod.gui.click.items.other;
    ...
    public static class Util {
        ...
        public void drawParticles() {
            ...
            for (Particle particle : particles) {
                ...
                Color color = ColorUtil.injectAlpha(ClickGui.INSTANCE.colorParticles.getValue() ? Managers.COLORS.getCurrent() : new Color(0x99C9C5C5), (int) alpha);
