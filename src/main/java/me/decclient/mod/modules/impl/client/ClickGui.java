...
import me.decclient.api.events.impl.ClientEvent;
...
public class ClickGui extends Module {
    ...
    public final Setting<Style> style =
            add(new Setting<>("Style", Style.FUTURE));
    ...
    public final Setting<Boolean> background =
            add(new Setting<>("Background", false));
    ...
    public final Setting<Boolean> rainbow =
            add(new Setting<>("Rainbow", true).setParent());
    ...
    public void onEnable() {
        if (mc.world != null){
            mc.displayGuiScreen(DecClickGui.INSTANCE);
        }
    ...
    @Override
    public void onTick() {
        if (!(mc.currentScreen instanceof DecClickGui) && !(mc.currentScreen instanceof GuiMainMenu)) {
            disable();
        }
    }
