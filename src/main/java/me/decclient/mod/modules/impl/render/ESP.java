...
import me.decclient.api.util.math.InterpolationUtil;
...
public class ESP extends Module {
    ...
    private void drawBurrowESP(BlockPos pos) {
        ...
        if (block == Blocks.ENDER_CHEST) {
            mc.getTextureManager().bindTexture(new ResourceLocation("textures/dec/constant/ingame/echest.png"));

        } else if (block == Blocks.WEB) {
            mc.getTextureManager().bindTexture(new ResourceLocation("textures/dec/constant/ingame/web.png"));

        } else {
            mc.getTextureManager().bindTexture(new ResourceLocation("textures/dec/constant/ingame/obby.png"));
        }
