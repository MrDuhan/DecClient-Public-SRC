...
public class HoleESP extends Module {
    ...
    private final Setting<Boolean> renderOwn =
            add(new Setting<>("RenderOwn", false, v -> page.getValue() == Page.GLOBAL));
    private final Setting<Boolean> fov =
            add(new Setting<>("FovOnly", false, v -> page.getValue() == Page.GLOBAL));
    private final Setting<Integer> range =
            add(new Setting<>("Range", 25, 0, 25, v -> page.getValue() == Page.GLOBAL));
    ...
    private final Setting<Boolean> wireframe =
            add(new Setting<>("Wireframe", false, v -> page.getValue() == Page.GLOBAL).setParent());
    ...
    private final Setting<Double> height =
            add(new Setting<>("Height", -0.9, -2.0, 2.0, v -> page.getValue() == Page.GLOBAL));
    private final Setting<Integer> boxAlpha =
            add(new Setting<>("BoxAlpha", 100, 0, 255, v -> box.getValue() && page.getValue() == Page.GLOBAL));
    private final Setting<Float> lineWidth =
            add(new Setting<>("LineWidth", 0.9f, 0.1f, 5.0f, v -> (outline.getValue() || wireframe.getValue()) && page.getValue() == Page.GLOBAL));
