...
import me.decclient.mod.modules.impl.exploit.XCarry;
...
public class AutoArmor extends Module {
    ...
    public void onKeyInput(InputEvent.KeyInputEvent event) {
        if (Keyboard.getEventKeyState() && !(mc.currentScreen instanceof DecClickGui) && elytraBind.getValue().getKey() == Keyboard.getEventKey()) {
            elytraOn = !elytraOn;
        }
        if (Keyboard.getEventKeyState() && !(mc.currentScreen instanceof DecClickGui) && noHelmBind.getValue().getKey() == Keyboard.getEventKey()) {
            helmOff = !helmOff;
        }
    }
